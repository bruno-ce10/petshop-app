...
const styles = StyleSheet.create({
  ...
  serviceText: { fontSize: 13, color: colors.textSecondary, marginTop: 6 },
  ...
  cancelLink: { fontSize: 12, color: colors.danger, marginTop: 8, fontWeight: "500" },
  deleteLink: { fontSize: 12, color: colors.textSecondary, marginTop: 8, fontWeight: "500" },
});
